...
const Footer = () => {
  return (
    ...
    <div className="m-auto rounded-3xl  shadow-black shadow-2xl bg-white  container py-16 mt-12   xl:px-32 lg:px-32 sm:px-6 px-4">
  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
    <div className="lg:flex flex-col hidden  flex-shrink-0">
      ...
      <div className="sm:ml-0 ml-8 flex flex-col">
          <h2 className="text-base font-semibold leading-4 text-gray-800 dark:text-black">Company</h2>
          <a href="javascript:void(0)" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-black cursor-pointer">Blog</a>
          <a href="javascript:void(0)" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-black cursor-pointer">Pricing</a>
          <a href="javascript:void(0)" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-black cursor-pointer">About Us</a>
          <a href="javascript:void(0)" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-black cursor-pointer">Contact us</a>
          <a href="javascript:void(0)" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-black cursor-pointer">Testimonials</a>
      </div>
      <div className="flex flex-col">
          <h2 className="text-base font-semibold leading-4 text-gray-800 dark:text-black">Support</h2>
          <a href="javascript:void(0)" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-black cursor-pointer">Legal policy</a>
          <a href="javascript:void(0)" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-black cursor-pointer">Status policy</a>
          <a href="javascript:void(0)" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-black cursor-pointer">Privacy policy</a>
          <a href="javascript:void(0)" className="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-black cursor-pointer">Terms of service</a>
      </div>
  ...
  <div className="p-6 max-w-sm mx-auto  flex flex-col items-center space-x-4">
    <p className="text-sm leading-none text-gray-800 mt-4 dark:text-slate-600">Copyright © 2024 kuwarp</p>
    <p className="text-sm leading-none text-gray-800 mt-4 dark:text-black">All rights reserved</p>
  </div>
